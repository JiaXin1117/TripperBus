...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_http_service_http_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_config__ = __webpack_require__(249);
        ...
        this._httpService.sendGetRequestWithParams(stops_url)
            ...
            _this._httpService.sendGetRequestWithParams(url)
                ...
                if (response['state'] == 'success') {
                    ...
                    jQuery(".panel-body").empty();
                    for (var i = 0; i < Object.keys(grouped_items).length; i++) {
                        var item = grouped_items[i];
                        var idx_1 = i + 1;
                        var html = "<div class='col-sm-6 col-md-4'>" +
                            "<div class='alert alert-success alert-success-admin-sche-edit'>" +
                            "<h3 class='text-center admin-sche-edit'>BUS #" + idx_1 + "</h3>" +
                            "<div class='row'>" +
                            "<div class='col-sm-5'>" +
                            "<h5 class='text-center admin-sche-edit'>Stop</h5>" +
                            "</div>" +
                            "<div class='col-sm-4'>" +
                            "<h5 class='text-center admin-sche-edit'>Hour</h5>" +
                            "</div>" +
                            "<div class='col-sm-3'>" +
                            "<h5 class='text-center admin-sche-edit'>Min</h5>" +
                            "</div>" +
                            "</div>" +
                        ...
                        html += "</div>" +
                            ...
                            "<button class='btn btn-sm btn-success' style='margin-right: 5px;'><span class='fa fa-save'></span> Save</button>" +
                            "<button class='btn btn-sm btn-danger'><span class='fa fa-trash-o'></span> Remove</button>" +
                            "</div>" +
                            "</div>" +
                            "</div>" +
                            "</div>";
                        jQuery('.panel-body').append(html);
                    }
                }
            });
        });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_common_service_common_service__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(249);
...
var AdminSchedulesComponent = (function () {
    ...
    AdminSchedulesComponent.prototype.connectEventsToElements = function () {
        var me = this;
        jQuery("#calendar_main").on("click", "h3", function () {
            var selected_date = jQuery(this).text();
            me.onClickEachDate(selected_date);
        });
    };
    AdminSchedulesComponent.prototype.onClickEachDate = function (selected_date) {
        var me = this;
        ...
        this._httpService.sendGetRequestWithParams(url)
            ...
            if (response['state'] == 'success') {
                ...
                var html = void 0;
                jQuery("#schedule_infos").empty();
                for (var i = 0; i < Object.keys(grouped_items).length; i++) {
                    var temp_i = i + 1;
                    html = "<p><strong>Bus " + temp_i + ":</strong></p>";
                    jQuery("#schedule_infos").append(html);
                    for (var j = 0; j < Object.keys(grouped_items[i]).length; j++) {
                        var item = grouped_items[i][j];
                        html = "<p>" + item['time'] + " from " + "stop_area" + "</p>";
                        jQuery("#schedule_infos").append(html);
                    }
                }
                me.showModal();
    ...
    AdminSchedulesComponent.prototype.addDaysInDateRange = function (firstDay, lastDay) {
        var _this = this;
        if (firstDay.getDate() == 1) {
            var dow = firstDay.getDay();
            for (var i = 0; i < dow; i++) {
                jQuery("#calendar_main").append("<div class='col-md-1 fix-height' style='min-height: 0px;'></div>");
            }
        }
                ...
                while (firstDay <= lastDay) {
                    ...
                    if (record_cnt > 0) {
                        ...
                        if (firstDay.getDate() < 10) {
                            html = "<div id='admin_schedule_each_date' class='col-md-1 fix-height'><h3>0" + firstDay.getDate() + "</h3><p>";
                        }
                        else {
                            html = "<div id='admin_schedule_each_date' class='col-md-1 fix-height'><h3>" + firstDay.getDate() + "</h3><p>";
                        }
                        if (record_cnt > 1) {
                            html += record_cnt + " buses</p></div>";
                        }
                        else {
                            html += record_cnt + " bus</p></div>";
                        }
                        jQuery("#calendar_main").append(html);
                    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__admin_component__ = __webpack_require__(596);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_config__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_http__ = __webpack_require__(235);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_module__ = __webpack_require__(599);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__admin_admin_schedules_editexisting_admin_schedules_editexisting_component__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__admin_admin_schedules_gennew_admin_schedules_gennew_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__admin_admin_schedules_genspecial_admin_schedules_genspecial_component__ = __webpack_require__(380);
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'schedules_edit/:sel_date', component: __WEBPACK_IMPORTED_MODULE_19__admin_admin_schedules_editexisting_admin_schedules_editexisting_component__["a" /* AdminSchedulesEditexistingComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_routing_app_routing_module__ = __webpack_require__(597);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_component__ = __webpack_require__(598);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__page_not_found_page_not_found_component__ = __webpack_require__(602);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__admin_admin_sidebar_admin_sidebar_component__ = __webpack_require__(595);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_http_service_http_service__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__main_main_header_main_header_component__ = __webpack_require__(601);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__main_main_index_component__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__main_main_footer_main_footer_component__ = __webpack_require__(600);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__admin_admin_schedules_editexisting_admin_schedules_editexisting_component__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__admin_admin_schedules_gennew_admin_schedules_gennew_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__admin_admin_schedules_genspecial_admin_schedules_genspecial_component__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__main_logout_logout_component__ = __webpack_require__(387);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_31__admin_admin_schedules_editexisting_admin_schedules_editexisting_component__["a" /* AdminSchedulesEditexistingComponent */],
                __WEBPACK_IMPORTED_MODULE_32__admin_admin_schedules_gennew_admin_schedules_gennew_component__["a" /* AdminSchedulesGennewComponent */],
                __WEBPACK_IMPORTED_MODULE_33__admin_admin_schedules_genspecial_admin_schedules_genspecial_component__["a" /* AdminSchedulesGenspecialComponent */],
                __WEBPACK_IMPORTED_MODULE_34__main_logout_logout_component__["a" /* LogoutComponent */],
            ],
            imports: [
