...
var AdminSchedulesEditexistingComponent = (function () {
    ...
    AdminSchedulesEditexistingComponent.prototype.doActions = function () {
        var me = this;
        ...
        this._httpService.sendGetRequestWithParams(url)
            ...
            if (response['state'] == 'success') {
                ...
                for (var i = 0; i < Object.keys(response['data']).length; i++) {
                    ...
                    if (item['area_id'] == me.inputParams.area_id && item['w_h'] == me._commonService.w_hType.TYPE_WEEKLY) {
                        data_1 = item;
                        break;
                    }
                }
    ...
    AdminSchedulesEditexistingComponent.prototype.onGenNewSchedule = function () {
        var me = this;
        var insert_request = [];
        for (var i = 0; i < Object.keys(me.adding_stops).length; i++) {
            if (me.adding_stops[i] != "" && me.adding_hours[i] != "" && me.adding_mins[i] != "" && me.adding_prices[i] != "") {
    ...
    AdminSchedulesEditexistingComponent.prototype.onGenSpecialSchedule = function () {
        var me = this;
        var insert_request = [];
        for (var i = 0; i < Object.keys(me.adding_stops).length; i++) {
            if (me.adding_stops[i] != "" && me.adding_hours[i] != "" && me.adding_mins[i] != "" && me.adding_prices[i] != "") {
