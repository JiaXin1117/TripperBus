...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_main_service_main_service__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_schedule_service_schedule_service__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_main_service_main_service__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_schedule_service_schedule_service__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_http_service_http_service__ = __webpack_require__(54);
...
var AdminMainRegularModeComponent = (function () {
    ...
    AdminMainRegularModeComponent.prototype.get_schedule_type = function (param_schedules) {
        var me = this;
    ...
    AdminMainRegularModeComponent.prototype.get_reservations_cnt = function (param_reservations, param_item) {
        var me = this;
        var cnt = 0;
        for (var i = 0; i < Object.keys(param_reservations).length; i++) {
            var item = param_reservations[i];
    ...
    AdminMainRegularModeComponent.prototype.get_schedules_for_outbound = function () {
        ...
        me._httpService.sendGetRequestWithParams(url)
            ...
            if (response['state'] == 'success') {
                var dayInfos_1 = response['data'];
                // Get schedule type of outbound date.
                var schedule_type_1 = me.get_schedule_type(dayInfos_1);
                var weekly_schedule_latest_date_1;
                // Get latest schedule date for weekly schedule.
                if (schedule_type_1 == me._scheduleService.w_hType.TYPE_WEEKLY) {
                    // Collect weekly dates for this date.
                    var temp_dates = [];
                    for (var i = 0; i < Object.keys(dayInfos_1).length; i++) {
                        var item = dayInfos_1[i];
                        if (item['w_h'] == me._scheduleService.w_hType.TYPE_WEEKLY && item['area_id'] == me.inputParams.leaving_from) {
                            temp_dates.push(item['date']);
                        }
                    }
                    weekly_schedule_latest_date_1 = me._scheduleService.getLatestWeeklyDate(temp_dates);
                }
                // Collect group ids.
                var group_ids_1 = me._scheduleService.collectGroupIDs(dayInfos_1);
                if (Object.keys(group_ids_1).length == 0) {
                    return;
                }
                // *********************** Get group main informations.
                var reservation_url = me._mainService.URLS.retrieve_reservations_by_date_url + "?date="
                    + __WEBPACK_IMPORTED_MODULE_5_moment__(me.inputParams.outbound_date).utc().format("YYYY-MM-DD")
                ...
                me._httpService.sendGetRequestWithParams(reservation_url)
                    ...
                    var grouped_items = [];
                    for (var i = 0; i < Object.keys(group_ids_1).length; i++) {
                        var temp = [];
                        for (var j = 0; j < Object.keys(dayInfos_1).length; j++) {
                            var item = dayInfos_1[j];
                            if (group_ids_1[i] == item['group_id'] && item['area_id'] == me.inputParams.leaving_from
                                && item['w_h'] == schedule_type_1) {
                                if (schedule_type_1 == me._scheduleService.w_hType.TYPE_WEEKLY) {
                                    if (item['date'] != weekly_schedule_latest_date_1)
                                        continue;
                                }
    ...
    AdminMainRegularModeComponent.prototype.get_stop_info_from_stopshort = function (param_stop_short) {
        var me = this;
        for (var i = 0; i < Object.keys(me.all_stops).length; i++) {
            var stop = me.all_stops[i];
    ...
    AdminMainRegularModeComponent.prototype.get_all_stops = function () {
        var me = this;
        var stops_url = me._mainService.URLS.retrieve_all_stops_url;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_http_service_http_service__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_environment__ = __webpack_require__(719);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__ = __webpack_require__(98);
...
var AdminMainBusComponent = (function () {
    function AdminMainBusComponent(_httpService, _scheduleService, _mainService) {
        ...
        this._scheduleService = _scheduleService;
        this._mainService = _mainService;
        this.group_main_info = [];
        this.group_additional_info = [];
        this.group_total_reservations = 0;
    }
    ...
    Object.defineProperty(AdminMainBusComponent.prototype, "selected_group_additional_info", {
        set: function (param_group_additional_infos) {
            var me = this;
    ...
    ], AdminMainBusComponent.prototype, "selected_group_main_info", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(), 
        __metadata('design:type', Array), 
        __metadata('design:paramtypes', [Array])
    ], AdminMainBusComponent.prototype, "selected_group_additional_info", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(), 
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__admin_admin_sidebar_admin_sidebar_component__ = __webpack_require__(711);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__main_main_footer_main_footer_component__ = __webpack_require__(716);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__admin_admin_schedules_admin_schedules_gennew_admin_schedules_gennew_component__ = __webpack_require__(709);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__admin_admin_schedules_admin_schedules_genspecial_admin_schedules_genspecial_component__ = __webpack_require__(710);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__admin_admin_schedules_admin_schedules_editexisting_admin_schedule_edit_bus_admin_schedule_edit_bus_component__ = __webpack_require__(708);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__admin_admin_main_admin_main_regular_mode_admin_main_bus_admin_main_bus_component__ = __webpack_require__(707);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_40__admin_admin_main_admin_main_regular_mode_admin_main_bus_admin_main_bus_component__["a" /* AdminMainBusComponent */],
            ],
            imports: [
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_config__ = __webpack_require__(82);
