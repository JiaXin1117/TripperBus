...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-areas.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-coupons-campaigns.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-coupons-companies.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-coupons-types.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-coupons.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-customers.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_main_service_main_service__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__admin_main_bus_editor_admin_main_bus_editor_component__ = __webpack_require__(360);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_5__admin_main_bus_editor_admin_main_bus_editor_component__["a"]; });
...
var AdminMainBusEditModeComponent = (function () {
    function AdminMainBusEditModeComponent(_route, _router, _mainService, _scheduleService, _httpService) {
        this._route = _route;
    ...
    AdminMainBusEditModeComponent.prototype.ngOnInit = function () {
        ...
        var url = this._mainService.URLS.get_buses_for_edit + "?outbound_date=" + this.inputParams.outbound_date + "&leaving_from=" + this.inputParams.leaving_from + "&return_date=" + this.inputParams.return_date;
        this._httpService.sendGetRequestWithParams(url)
            .subscribe(function (data) {
            if (data.state == "success") {
                _this.leaving_buses = data.data_1;
                _this.returning_buses = data.data_2;
                _this._mainService.schedule_default_price = data.default_price;
            }
        });
    };
    ...
    AdminMainBusEditModeComponent.prototype.updateBuses = function () {
        var _this = this;
        var url = this._mainService.URLS.update_buses_for_edit + "?outbound_date=" + this.inputParams.outbound_date + "&leaving_from=" + this.inputParams.leaving_from + "&return_date=" + this.inputParams.return_date;
        var data = this.leaving_buses.concat(this.returning_buses);
        this._httpService.sendPostJSON(url, { buses: data })
            .subscribe(function (data) {
            _this.successMessage = "The buses are successfully updated.";
            _this.errorMessage = "";
        }, function (error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__admin_main_bus_move_admin_main_bus_move_component__ = __webpack_require__(361);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_5__admin_main_bus_move_admin_main_bus_move_component__["a"]; });
...
var AdminMainMovePeopleModeComponent = (function () {
    function AdminMainMovePeopleModeComponent(_route, _router, _mainService, _scheduleService, _httpService) {
        this._route = _route;
        this._router = _router;
        this._mainService = _mainService;
        this._scheduleService = _scheduleService;
    ...
    AdminMainMovePeopleModeComponent.prototype.refreshData = function () {
        var _this = this;
        var url = this._mainService.URLS.get_buses_for_move_people + "?outbound_date=" + this.inputParams.outbound_date + "&leaving_from=" + this.inputParams.leaving_from + "&return_date=" + this.inputParams.return_date;
        this._httpService.sendGetRequestWithParams(url)
            .subscribe(function (data) {
            if (data.state == "success") {
                _this.leaving_buses = data.data_1;
                _this.returning_buses = data.data_2;
                _this.leaving_times = data.time_1;
                _this.returning_times = data.time_2;
                _this._mainService.schedule_default_price = data.default_price;
            }
        });
    };
    ...
    AdminMainMovePeopleModeComponent.prototype.movePeople = function () {
        var _this = this;
        var url = this._mainService.URLS.move_reservations;
        var data = this.leaving_buses.concat(this.returning_buses);
        this._httpService.sendPostJSON(url, { buses: data })
            .subscribe(function (data) {
            _this.successMessage = "The reservations are successfully updated.";
            _this.errorMessage = "";
            _this.refreshData();
        }, function (error) {
            _this.successMessage = "";
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-move-people-mode.component.js.map
...
var AdminMainRegularModeComponent = (function () {
    function AdminMainRegularModeComponent(_route, _router, _mainService, _scheduleService, _httpService) {
        this._route = _route;
        this._router = _router;
        this._mainService = _mainService;
        this._scheduleService = _scheduleService;
        ...
        this.errorMessage = "";
        this.successMessage = "";
        this.outbound_timeId = 0;
        this.outbound_price = 0;
        this.returning_timeId = 0;
    ...
    AdminMainRegularModeComponent.prototype.outboundTimeSelected = function (data) {
        this.outbound_timeId = data.timeId;
        this.outbound_price = data.price;
    };
    AdminMainRegularModeComponent.prototype.returningTimeSelected = function (data) {
        this.returning_timeId = data.timeId;
        this.returning_price = data.price;
    };
    AdminMainRegularModeComponent.prototype.gotoNextStep = function () {
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-regular-mode.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_http_service_http_service__ = __webpack_require__(22);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminMainReservationComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AdminMainReservationComponent = (function () {
    function AdminMainReservationComponent(_route, _router, _mainService, _scheduleService, _httpService) {
        this._route = _route;
        this._router = _router;
        this._mainService = _mainService;
        this._scheduleService = _scheduleService;
    ...
    AdminMainReservationComponent.prototype.ngOnInit = function () {
        var _this = this;
        var me = this;
        me.receiveInputParams();
        me.structHeaderLeaving();
    ...
    AdminMainReservationComponent.prototype.receiveInputParams = function () {
        var me = this;
        me.inputParams.outbound_date = me._route.snapshot.params['outbound_date'];
        me.inputParams.leaving_from = me._route.snapshot.params['leaving_from'];
        me.inputParams.return_date = me._route.snapshot.params['return_date'];
    };
    AdminMainReservationComponent.prototype.structHeaderLeaving = function () {
        var me = this;
        me.headerLeave.city = me._scheduleService.getCityName(me.inputParams.leaving_from);
        me.headerLeave.date = me._scheduleService.getDateAsLongFormat(me.inputParams.outbound_date);
    };
    AdminMainReservationComponent.prototype.structHeaderReturn = function () {
        var me = this;
        // Set return city.
        if (me.inputParams.leaving_from == me._scheduleService.areaType.TYPE_NEWYORK) {
            me.headerReturn.city = me._scheduleService.getCityName(me._scheduleService.areaType.TYPE_BA);
    ...
    AdminMainReservationComponent.prototype.onClickBusEditMode = function () {
        var me = this;
        var link = ['/admin/main/bus_edit_mode', me.inputParams.outbound_date, me.inputParams.leaving_from, me.inputParams.return_date];
        me._router.navigate(link);
    };
    AdminMainReservationComponent.prototype.onClickMovePeopleMode = function () {
        var me = this;
        var link = ['/admin/main/move_people_mode', me.inputParams.outbound_date, me.inputParams.leaving_from, me.inputParams.return_date];
        me._router.navigate(link);
    };
    AdminMainReservationComponent.prototype.outboundTimeSelected = function (data) {
        this.outbound_timeId = data.timeId;
        this.outbound_price = data.price;
    };
    AdminMainReservationComponent.prototype.returningTimeSelected = function (data) {
        this.returning_timeId = data.timeId;
        this.returning_price = data.price;
    };
    AdminMainReservationComponent.prototype.gotoNextStep = function () {
        if (this.headerReturn.date != '' && this.returning_timeId == 0)
            return;
    };
    return AdminMainReservationComponent;
}());
AdminMainReservationComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-reservation.component.js.map
...
var _a, _b;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-pages.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-rates.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_http_service_http_service__ = __webpack_require__(22);
...
var _a, _b, _c, _d;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-schedules-editexisting.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_config__ = __webpack_require__(46);
...
var _a, _b, _c;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-schedules.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-settings.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-stops.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-users.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__admin_component__ = __webpack_require__(367);
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/index.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_auth_service_auth_service__ = __webpack_require__(71);
...
var _a, _b, _c, _d;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/login.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_auth_service_auth_service__ = __webpack_require__(71);
...
var _a, _b;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/logout.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/main-index.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__ = __webpack_require__(300);
...
var _a;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/http.service.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/schedule.service.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_config__ = __webpack_require__(46);
...
var MainService = (function () {
    function MainService() {
        ...
        this.URLS = {
            retrieve_schedules_by_date_url: __WEBPACK_IMPORTED_MODULE_1__config_config__["a" /* BACKEND_SERVER_URL */] + "api/admin/schedule/retrieve_by_date",
            ...
            get_buses_for_edit: __WEBPACK_IMPORTED_MODULE_1__config_config__["a" /* BACKEND_SERVER_URL */] + "api/admin/main/get_bus_times",
            update_buses_for_edit: __WEBPACK_IMPORTED_MODULE_1__config_config__["a" /* BACKEND_SERVER_URL */] + "api/admin/main/update_buses",
            move_reservations: __WEBPACK_IMPORTED_MODULE_1__config_config__["a" /* BACKEND_SERVER_URL */] + "api/admin/main/move_reservations",
            get_buses_for_move_people: __WEBPACK_IMPORTED_MODULE_1__config_config__["a" /* BACKEND_SERVER_URL */] + "api/admin/main/get_bus_for_move",
        };
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/main.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_module__ = __webpack_require__(370);
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/main.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-footer.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-header.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_bus_type__ = __webpack_require__(93);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminMainBusEditorComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AdminMainBusEditorComponent = (function () {
    function AdminMainBusEditorComponent(_httpService, _scheduleService, _mainService) {
        this._httpService = _httpService;
        this._scheduleService = _scheduleService;
        this._mainService = _mainService;
        this._bus = new __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]();
        this.group_idx = 0;
        this.total_reservation = 0;
    }
    AdminMainBusEditorComponent.prototype.ngOnInit = function () {
        var me = this;
    };
    Object.defineProperty(AdminMainBusEditorComponent.prototype, "bus", {
        set: function (bus) {
            var me = this;
            me._bus = bus;
            this.total_reservation = 0;
            for (var i = 0; i < this._bus.times.length; i++)
                this.total_reservation += this._bus.times[i].reservation_cnt;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AdminMainBusEditorComponent.prototype, "selected_group_idx", {
    ...
    Object.defineProperty(AdminMainBusEditorComponent.prototype, "price", {
        get: function () {
            var price = this._mainService.schedule_default_price;
    ...
    return AdminMainBusEditorComponent;
}());
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]) === "function" && _a || Object),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]) === "function" && _b || Object])
], AdminMainBusEditorComponent.prototype, "bus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", Number),
    __metadata("design:paramtypes", [Number])
], AdminMainBusEditorComponent.prototype, "selected_group_idx", null);
AdminMainBusEditorComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
        selector: 'app-admin-main-bus-editor',
        template: __webpack_require__(609),
        styles: [__webpack_require__(560)]
    }),
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__["a" /* HttpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_http_service_http_service__["a" /* HttpService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__["a" /* ScheduleService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__["a" /* ScheduleService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__["a" /* MainService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__["a" /* MainService */]) === "function" && _e || Object])
], AdminMainBusEditorComponent);

var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-bus-editor.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model__ = __webpack_require__(373);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminMainBusMoveComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AdminMainBusMoveComponent = (function () {
    function AdminMainBusMoveComponent(_httpService, _scheduleService, _mainService) {
        this._httpService = _httpService;
        this._scheduleService = _scheduleService;
        this._mainService = _mainService;
        this._bus = new __WEBPACK_IMPORTED_MODULE_4__model__["a" /* Bus */]();
        this.group_idx = 0;
        this.total_reservation = 0;
        this.price = 0;
    }
    AdminMainBusMoveComponent.prototype.ngOnInit = function () {
        var me = this;
    };
    Object.defineProperty(AdminMainBusMoveComponent.prototype, "bus", {
        set: function (bus) {
            var me = this;
            me._bus = bus;
            this.total_reservation = 0;
    ...
    Object.defineProperty(AdminMainBusMoveComponent.prototype, "times", {
        set: function (times) {
            this._times = times;
        },
        enumerable: true,
    ...
    Object.defineProperty(AdminMainBusMoveComponent.prototype, "selected_group_idx", {
        set: function (param_group_idx) {
            var me = this;
            me.group_idx = param_group_idx;
        },
    ...
    return AdminMainBusMoveComponent;
}());
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__model__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model__["a" /* Bus */]) === "function" && _a || Object),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__model__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model__["a" /* Bus */]) === "function" && _b || Object])
], AdminMainBusMoveComponent.prototype, "bus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], AdminMainBusMoveComponent.prototype, "times", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", Number),
    __metadata("design:paramtypes", [Number])
], AdminMainBusMoveComponent.prototype, "selected_group_idx", null);
AdminMainBusMoveComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-bus-move.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_main_service_main_service__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_bus_type__ = __webpack_require__(93);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminMainBusComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AdminMainBusComponent = (function () {
    function AdminMainBusComponent(_httpService, _scheduleService, _mainService) {
        this._httpService = _httpService;
        this._scheduleService = _scheduleService;
        this._mainService = _mainService;
        this.onTimeSelected = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["s" /* EventEmitter */]();
        this._bus = new __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]();
        this.group_idx = 0;
        this.total_reservation = 0;
        this.price = 0;
    ...
    Object.defineProperty(AdminMainBusComponent.prototype, "bus", {
        set: function (bus) {
            var me = this;
            me._bus = bus;
            this.total_reservation = 0;
    ...
    Object.defineProperty(AdminMainBusComponent.prototype, "busType", {
        set: function (type) {
            this._busType = type;
        },
        enumerable: true,
    ...
    Object.defineProperty(AdminMainBusComponent.prototype, "selected_group_idx", {
        set: function (param_group_idx) {
            var me = this;
            me.group_idx = param_group_idx;
        },
    ...
    AdminMainBusComponent.prototype.timeSelected = function (timeId) {
...
], AdminMainBusComponent.prototype, "onTimeSelected", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]) === "function" && _a || Object),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__model_bus_type__["a" /* Bus */]) === "function" && _b || Object])
], AdminMainBusComponent.prototype, "bus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AdminMainBusComponent.prototype, "busType", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Input */])(),
    __metadata("design:type", Number),
    __metadata("design:paramtypes", [Number])
], AdminMainBusComponent.prototype, "selected_group_idx", null);
AdminMainBusComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-main-bus.component.js.map
...
var _a, _b;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-schedule-edit-bus.component.js.map
...
var _a, _b, _c;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-schedules-gennew.component.js.map
...
var _a, _b, _c;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-schedules-genspecial.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin-sidebar.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/admin.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__admin_admin_main_admin_main_component__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__admin_admin_schedules_admin_schedules_component__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__admin_admin_stops_admin_stops_component__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__admin_admin_rates_admin_rates_component__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__admin_admin_areas_admin_areas_component__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__admin_admin_users_admin_users_component__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__admin_admin_customers_admin_customers_component__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__admin_admin_pages_admin_pages_component__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__admin_admin_settings_admin_settings_component__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__admin_admin_coupons_admin_coupons_component__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__admin_admin_coupons_campaigns_admin_coupons_campaigns_component__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__admin_admin_coupons_companies_admin_coupons_companies_component__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__admin_admin_coupons_types_admin_coupons_types_component__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__main_login_login_component__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__main_main_index_component__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__main_logout_logout_component__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__admin_admin_schedules_admin_schedules_editexisting_admin_schedules_editexisting_component__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__admin_admin_main_admin_main_regular_mode_admin_main_regular_mode_component__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__admin_admin_main_admin_main_bus_edit_mode_admin_main_bus_edit_mode_component__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__admin_admin_main_admin_main_move_people_mode_admin_main_move_people_mode_component__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__admin_admin_main_admin_main_reservation_admin_main_reservation_component__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__services_auth_service_auth_service__ = __webpack_require__(71);
...
var routes = [
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_24__services_auth_service_auth_service__["a" /* AuthService */]],
        children: [
            ...
            { path: 'main/reservation_mode/:outbound_time_id/:return_time_id', component: __WEBPACK_IMPORTED_MODULE_23__admin_admin_main_admin_main_reservation_admin_main_reservation_component__["a" /* AdminMainReservationComponent */] },
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/app-routing.module.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/app.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_routing_app_routing_module__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_component__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__page_not_found_page_not_found_component__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__admin__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__admin_admin_header_admin_header_component__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__admin_admin_sidebar_admin_sidebar_component__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__admin_admin_main_admin_main_component__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__admin_admin_schedules_admin_schedules_component__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__admin_admin_stops_admin_stops_component__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__admin_admin_rates_admin_rates_component__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__admin_admin_areas_admin_areas_component__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__admin_admin_users_admin_users_component__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__admin_admin_customers_admin_customers_component__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__admin_admin_pages_admin_pages_component__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__admin_admin_settings_admin_settings_component__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__admin_admin_coupons_admin_coupons_component__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__admin_admin_coupons_campaigns_admin_coupons_campaigns_component__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__admin_admin_coupons_companies_admin_coupons_companies_component__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__admin_admin_coupons_types_admin_coupons_types_component__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__admin_admin_footer_admin_footer_component__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__main_login_login_component__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_http_service_http_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__services_auth_service_auth_service__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__services_schedule_service_schedule_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__services_main_service_main_service__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__main_main_header_main_header_component__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__main_main_index_component__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__main_main_footer_main_footer_component__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__admin_admin_schedules_admin_schedules_editexisting_admin_schedules_editexisting_component__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__admin_admin_schedules_admin_schedules_gennew_admin_schedules_gennew_component__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__admin_admin_schedules_admin_schedules_genspecial_admin_schedules_genspecial_component__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__admin_admin_schedules_admin_schedules_editexisting_admin_schedule_edit_bus_admin_schedule_edit_bus_component__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__main_logout_logout_component__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__admin_admin_main_admin_main_regular_mode_admin_main_regular_mode_component__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__admin_admin_main_admin_main_bus_edit_mode_admin_main_bus_edit_mode_component__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__admin_admin_main_admin_main_move_people_mode_admin_main_move_people_mode_component__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__admin_admin_main_admin_main_reservation_admin_main_reservation_component__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__admin_admin_main_admin_main_regular_mode_admin_main_bus_admin_main_bus_component__ = __webpack_require__(362);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_38__admin_admin_main_admin_main_bus_edit_mode_admin_main_bus_edit_mode_component__["b" /* AdminMainBusEditorComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_39__admin_admin_main_admin_main_move_people_mode_admin_main_move_people_mode_component__["b" /* AdminMainBusMoveComponent */],
            __WEBPACK_IMPORTED_MODULE_41__admin_admin_main_admin_main_regular_mode_admin_main_bus_admin_main_bus_component__["a" /* AdminMainBusComponent */],
            __WEBPACK_IMPORTED_MODULE_40__admin_admin_main_admin_main_reservation_admin_main_reservation_component__["a" /* AdminMainReservationComponent */]
        ],
        imports: [
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/app.module.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/main-footer.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/main-header.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bus_type__ = __webpack_require__(93);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__bus_type__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__time_type__ = __webpack_require__(374);
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/time.type.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/page-not-found.component.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/environment.js.map
...
var BACKEND_SERVER_URL = "http://localhost:8080/TripperBus/";
// export const BACKEND_SERVER_URL = "http://54.214.196.171/TripperBus/public/";
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/config.js.map
...
// module
exports.push([module.i, ".alert-enabled {\r\n    background-color: #00a65a !important;\r\n}\r\n\r\n.alert-disabled {\r\n    background-color: orange !important;\r\n}\r\n\r\nh3, h5 {\r\n    color: white !important;\r\n}\r\n\r\n.max-capacity-div {\r\n    margin-top: 10px;\r\n}\r\n\r\n.destination-div {\r\n    margin-top: 10px;\r\n}\r\n\r\n.input-max-capacity {\r\n    text-align: center;\r\n    width: 50px;\r\n}\r\n\r\n.col-sm-4-custom {\r\n    padding-right: 0px;\r\n}", ""]);
...
module.exports = "<div class=\"col-xs-12 bus-root-div\">\n      <h3 class=\"text-center bus-header-h3\">BUS #{{ group_idx + 1 }}</h3>\n      \n      <div class=\"group-main-info\">\n          <table class=\"schedules-table\">\n              <tr *ngFor=\"let time of _bus.times; let i = index;\">\n                  <td class=\"td-left\">\n                      <span>TIME ID: {{ time.id }} {{ time.time }}</span> from <span>{{ time.stop_area }}</span> \n                  </td>\n                  <td class=\"td-right\">\n                      <span>{{ time.reservation_cnt }}</span>\n                  </td>\n              </tr>\n          </table>\n          <p >\n              \n          </p>\n      </div>\n      <div class=\"group-additional-info\">\n          <h5 class=\"total-h5\">\n              Total: {{ total_reservation }}.  Max Capacity: \n              <input type=\"text\" name=\"max_cap\" [(ngModel)] = \"_bus.max_cap\">\n          </h5>\n          <table class=\"group-additional-info-table\">\n              \n              <tr>\n                  <td class=\"td-left\">\n                      TravelZoo Booked: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.travel_zoo_booked}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Coupons Allowed: \n                  </td>  \n                  <td class=\"td-right\">\n                      \n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Price: \n                  </td>  \n                  <td class=\"td-right\">\n                      ${{price}}\n                  </td>\n              </tr>\n          </table>\n          \n      </div>\n      <div class=\"group-additional-info price-table\">\n        <table class=\"group-additional-info-table\">\n            \n            <tr>\n                <td class=\"td-left\">\n                    Price for the first \n                    <select name=\"first_seats\" [(ngModel)] = \"_bus.price.first_seats\">\n                        <option value=\"\"> </option>\n                        <option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option><option value=\"15\">15</option>\n                    </select>\n                    seats: \n                    <select name=\"first_price\" [(ngModel)] = \"_bus.price.first_price\">\n                        <option value=\"1.00\">$1.00</option><option value=\"1.50\">$1.50</option><option value=\"2.00\">$2.00</option><option value=\"2.50\">$2.50</option><option value=\"3.00\">$3.00</option><option value=\"3.50\">$3.50</option><option value=\"4.00\">$4.00</option><option value=\"4.50\">$4.50</option>\n                        <option value=\"5.00\">$5.00</option><option value=\"5.50\">$5.50</option><option value=\"6.00\">$6.00</option><option value=\"6.50\">$6.50</option><option value=\"7.00\">$7.00</option><option value=\"7.50\">$7.50</option><option value=\"8.00\">$8.00</option><option value=\"8.50\">$8.50</option>\n                        <option value=\"9.00\">$9.00</option><option value=\"9.50\">$9.50</option><option value=\"10.00\">$10.00</option><option value=\"10.50\">$10.50</option><option value=\"11.00\">$11.00</option><option value=\"11.50\">$11.50</option><option value=\"12.00\">$12.00</option><option value=\"12.50\">$12.50</option>\n                        <option value=\"13.00\">$13.00</option><option value=\"13.50\">$13.50</option><option value=\"14.00\">$14.00</option><option value=\"14.50\">$14.50</option><option value=\"15.00\">$15.00</option><option value=\"15.50\">$15.50</option><option value=\"16.00\">$16.00</option><option value=\"16.50\">$16.50</option>\n                        <option value=\"17.00\">$17.00</option><option value=\"17.50\">$17.50</option><option value=\"18.00\">$18.00</option><option value=\"18.50\">$18.50</option><option value=\"19.00\">$19.00</option><option value=\"19.50\">$19.50</option><option value=\"20.00\">$20.00</option><option value=\"20.50\">$20.50</option>\n                        <option value=\"21.00\">$21.00</option><option value=\"21.50\">$21.50</option><option value=\"22.00\">$22.00</option><option value=\"22.50\">$22.50</option><option value=\"23.00\">$23.00</option><option value=\"23.50\">$23.50</option><option value=\"24.00\">$24.00</option><option value=\"24.50\">$24.50</option>\n                        <option value=\"25.00\">$25.00</option><option value=\"25.50\">$25.50</option><option value=\"26.00\">$26.00</option><option value=\"26.50\">$26.50</option><option value=\"27.00\">$27.00</option><option value=\"27.50\">$27.50</option><option value=\"28.00\">$28.00</option><option value=\"28.50\">$28.50</option>\n                        <option value=\"29.00\">$29.00</option><option value=\"29.50\">$29.50</option><option value=\"30.00\">$30.00</option><option value=\"30.50\">$30.50</option><option value=\"31.00\">$31.00</option><option value=\"31.50\">$31.50</option><option value=\"32.00\">$32.00</option><option value=\"32.50\">$32.50</option>\n                        <option value=\"33.00\">$33.00</option><option value=\"33.50\">$33.50</option><option value=\"34.00\">$34.00</option><option value=\"34.50\">$34.50</option><option value=\"35.00\">$35.00</option><option value=\"35.50\">$35.50</option><option value=\"36.00\">$36.00</option><option value=\"36.50\">$36.50</option>\n                        <option value=\"37.00\">$37.00</option><option value=\"37.50\">$37.50</option><option value=\"38.00\">$38.00</option><option value=\"38.50\">$38.50</option><option value=\"39.00\">$39.00</option><option value=\"39.50\">$39.50</option><option value=\"40.00\">$40.00</option><option value=\"40.50\">$40.50</option>\n                        <option value=\"41.00\">$41.00</option><option value=\"41.50\">$41.50</option><option value=\"42.00\">$42.00</option><option value=\"42.50\">$42.50</option><option value=\"43.00\">$43.00</option><option value=\"43.50\">$43.50</option><option value=\"44.00\">$44.00</option><option value=\"44.50\">$44.50</option>\n                        <option value=\"45.00\">$45.00</option><option value=\"45.50\">$45.50</option><option value=\"46.00\">$46.00</option><option value=\"46.50\">$46.50</option><option value=\"47.00\">$47.00</option><option value=\"47.50\">$47.50</option><option value=\"48.00\">$48.00</option><option value=\"48.50\">$48.50</option>\n                        <option value=\"49.00\">$49.00</option><option value=\"49.50\">$49.50</option><option value=\"50.00\">$50.00</option><option value=\"50.50\">$50.50</option><option value=\"51.00\">$51.00</option><option value=\"51.50\">$51.50</option><option value=\"52.00\">$52.00</option><option value=\"52.50\">$52.50</option>\n                        <option value=\"53.00\">$53.00</option><option value=\"53.50\">$53.50</option><option value=\"54.00\">$54.00</option><option value=\"54.50\">$54.50</option><option value=\"55.00\">$55.00</option><option value=\"55.50\">$55.50</option><option value=\"56.00\">$56.00</option><option value=\"56.50\">$56.50</option>\n                        <option value=\"57.00\">$57.00</option><option value=\"57.50\">$57.50</option><option value=\"58.00\">$58.00</option><option value=\"58.50\">$58.50</option><option value=\"59.00\">$59.00</option><option value=\"59.50\">$59.50</option><option value=\"60.00\">$60.00</option><option value=\"60.50\">$60.50</option>\n                        <option value=\"61.00\">$61.00</option><option value=\"61.50\">$61.50</option><option value=\"62.00\">$62.00</option><option value=\"62.50\">$62.50</option><option value=\"63.00\">$63.00</option><option value=\"63.50\">$63.50</option><option value=\"64.00\">$64.00</option><option value=\"64.50\">$64.50</option>\n                        <option value=\"65.00\">$65.00</option><option value=\"65.50\">$65.50</option><option value=\"66.00\">$66.00</option><option value=\"66.50\">$66.50</option><option value=\"67.00\">$67.00</option><option value=\"67.50\">$67.50</option><option value=\"68.00\">$68.00</option><option value=\"68.50\">$68.50</option>\n                        <option value=\"69.00\">$69.00</option><option value=\"69.50\">$69.50</option><option value=\"70.00\">$70.00</option><option value=\"70.50\">$70.50</option><option value=\"71.00\">$71.00</option><option value=\"71.50\">$71.50</option><option value=\"72.00\">$72.00</option><option value=\"72.50\">$72.50</option>\n                        <option value=\"73.00\">$73.00</option><option value=\"73.50\">$73.50</option><option value=\"74.00\">$74.00</option><option value=\"74.50\">$74.50</option><option value=\"75.00\">$75.00</option><option value=\"75.50\">$75.50</option><option value=\"76.00\">$76.00</option><option value=\"76.50\">$76.50</option>\n                        <option value=\"77.00\">$77.00</option><option value=\"77.50\">$77.50</option><option value=\"78.00\">$78.00</option><option value=\"78.50\">$78.50</option><option value=\"79.00\">$79.00</option><option value=\"79.50\">$79.50</option><option value=\"80.00\">$80.00</option><option value=\"80.50\">$80.50</option>\n                        <option value=\"81.00\">$81.00</option><option value=\"81.50\">$81.50</option><option value=\"82.00\">$82.00</option><option value=\"82.50\">$82.50</option><option value=\"83.00\">$83.00</option><option value=\"83.50\">$83.50</option><option value=\"84.00\">$84.00</option><option value=\"84.50\">$84.50</option>\n                        <option value=\"85.00\">$85.00</option><option value=\"85.50\">$85.50</option><option value=\"86.00\">$86.00</option><option value=\"86.50\">$86.50</option><option value=\"87.00\">$87.00</option><option value=\"87.50\">$87.50</option><option value=\"88.00\">$88.00</option><option value=\"88.50\">$88.50</option>\n                        <option value=\"89.00\">$89.00</option><option value=\"89.50\">$89.50</option><option value=\"90.00\">$90.00</option><option value=\"90.50\">$90.50</option><option value=\"91.00\">$91.00</option><option value=\"91.50\">$91.50</option><option value=\"92.00\">$92.00</option><option value=\"92.50\">$92.50</option>\n                        <option value=\"93.00\">$93.00</option><option value=\"93.50\">$93.50</option><option value=\"94.00\">$94.00</option><option value=\"94.50\">$94.50</option><option value=\"95.00\">$95.00</option><option value=\"95.50\">$95.50</option><option value=\"96.00\">$96.00</option><option value=\"96.50\">$96.50</option>\n                        <option value=\"97.00\">$97.00</option><option value=\"97.50\">$97.50</option><option value=\"98.00\">$98.00</option><option value=\"98.50\">$98.50</option><option value=\"99.00\">$99.00</option><option value=\"99.50\">$99.50</option><option value=\"100.00\">$100.00</option>\n                    </select>\n                </td>\n            </tr>\n            <tr>\n                <td class=\"td-left\">\n                    Special price for whole bus: \n                    <select name=\"special_price\" [(ngModel)] = \"_bus.price.special_price\">\n                        <option value=\"\"> </option>\n                        <option value=\"1.00\">$1.00</option><option value=\"1.50\">$1.50</option><option value=\"2.00\">$2.00</option><option value=\"2.50\">$2.50</option><option value=\"3.00\">$3.00</option><option value=\"3.50\">$3.50</option><option value=\"4.00\">$4.00</option><option value=\"4.50\">$4.50</option>\n                        <option value=\"5.00\">$5.00</option><option value=\"5.50\">$5.50</option><option value=\"6.00\">$6.00</option><option value=\"6.50\">$6.50</option><option value=\"7.00\">$7.00</option><option value=\"7.50\">$7.50</option><option value=\"8.00\">$8.00</option><option value=\"8.50\">$8.50</option>\n                        <option value=\"9.00\">$9.00</option><option value=\"9.50\">$9.50</option><option value=\"10.00\">$10.00</option><option value=\"10.50\">$10.50</option><option value=\"11.00\">$11.00</option><option value=\"11.50\">$11.50</option><option value=\"12.00\">$12.00</option><option value=\"12.50\">$12.50</option>\n                        <option value=\"13.00\">$13.00</option><option value=\"13.50\">$13.50</option><option value=\"14.00\">$14.00</option><option value=\"14.50\">$14.50</option><option value=\"15.00\">$15.00</option><option value=\"15.50\">$15.50</option><option value=\"16.00\">$16.00</option><option value=\"16.50\">$16.50</option>\n                        <option value=\"17.00\">$17.00</option><option value=\"17.50\">$17.50</option><option value=\"18.00\">$18.00</option><option value=\"18.50\">$18.50</option><option value=\"19.00\">$19.00</option><option value=\"19.50\">$19.50</option><option value=\"20.00\">$20.00</option><option value=\"20.50\">$20.50</option>\n                        <option value=\"21.00\">$21.00</option><option value=\"21.50\">$21.50</option><option value=\"22.00\">$22.00</option><option value=\"22.50\">$22.50</option><option value=\"23.00\">$23.00</option><option value=\"23.50\">$23.50</option><option value=\"24.00\">$24.00</option><option value=\"24.50\">$24.50</option>\n                        <option value=\"25.00\">$25.00</option><option value=\"25.50\">$25.50</option><option value=\"26.00\">$26.00</option><option value=\"26.50\">$26.50</option><option value=\"27.00\">$27.00</option><option value=\"27.50\">$27.50</option><option value=\"28.00\">$28.00</option><option value=\"28.50\">$28.50</option>\n                        <option value=\"29.00\">$29.00</option><option value=\"29.50\">$29.50</option><option value=\"30.00\">$30.00</option><option value=\"30.50\">$30.50</option><option value=\"31.00\">$31.00</option><option value=\"31.50\">$31.50</option><option value=\"32.00\">$32.00</option><option value=\"32.50\">$32.50</option>\n                        <option value=\"33.00\">$33.00</option><option value=\"33.50\">$33.50</option><option value=\"34.00\">$34.00</option><option value=\"34.50\">$34.50</option><option value=\"35.00\">$35.00</option><option value=\"35.50\">$35.50</option><option value=\"36.00\">$36.00</option><option value=\"36.50\">$36.50</option>\n                        <option value=\"37.00\">$37.00</option><option value=\"37.50\">$37.50</option><option value=\"38.00\">$38.00</option><option value=\"38.50\">$38.50</option><option value=\"39.00\">$39.00</option><option value=\"39.50\">$39.50</option><option value=\"40.00\">$40.00</option><option value=\"40.50\">$40.50</option>\n                        <option value=\"41.00\">$41.00</option><option value=\"41.50\">$41.50</option><option value=\"42.00\">$42.00</option><option value=\"42.50\">$42.50</option><option value=\"43.00\">$43.00</option><option value=\"43.50\">$43.50</option><option value=\"44.00\">$44.00</option><option value=\"44.50\">$44.50</option>\n                        <option value=\"45.00\">$45.00</option><option value=\"45.50\">$45.50</option><option value=\"46.00\">$46.00</option><option value=\"46.50\">$46.50</option><option value=\"47.00\">$47.00</option><option value=\"47.50\">$47.50</option><option value=\"48.00\">$48.00</option><option value=\"48.50\">$48.50</option>\n                        <option value=\"49.00\">$49.00</option><option value=\"49.50\">$49.50</option><option value=\"50.00\">$50.00</option><option value=\"50.50\">$50.50</option><option value=\"51.00\">$51.00</option><option value=\"51.50\">$51.50</option><option value=\"52.00\">$52.00</option><option value=\"52.50\">$52.50</option>\n                        <option value=\"53.00\">$53.00</option><option value=\"53.50\">$53.50</option><option value=\"54.00\">$54.00</option><option value=\"54.50\">$54.50</option><option value=\"55.00\">$55.00</option><option value=\"55.50\">$55.50</option><option value=\"56.00\">$56.00</option><option value=\"56.50\">$56.50</option>\n                        <option value=\"57.00\">$57.00</option><option value=\"57.50\">$57.50</option><option value=\"58.00\">$58.00</option><option value=\"58.50\">$58.50</option><option value=\"59.00\">$59.00</option><option value=\"59.50\">$59.50</option><option value=\"60.00\">$60.00</option><option value=\"60.50\">$60.50</option>\n                        <option value=\"61.00\">$61.00</option><option value=\"61.50\">$61.50</option><option value=\"62.00\">$62.00</option><option value=\"62.50\">$62.50</option><option value=\"63.00\">$63.00</option><option value=\"63.50\">$63.50</option><option value=\"64.00\">$64.00</option><option value=\"64.50\">$64.50</option>\n                        <option value=\"65.00\">$65.00</option><option value=\"65.50\">$65.50</option><option value=\"66.00\">$66.00</option><option value=\"66.50\">$66.50</option><option value=\"67.00\">$67.00</option><option value=\"67.50\">$67.50</option><option value=\"68.00\">$68.00</option><option value=\"68.50\">$68.50</option>\n                        <option value=\"69.00\">$69.00</option><option value=\"69.50\">$69.50</option><option value=\"70.00\">$70.00</option><option value=\"70.50\">$70.50</option><option value=\"71.00\">$71.00</option><option value=\"71.50\">$71.50</option><option value=\"72.00\">$72.00</option><option value=\"72.50\">$72.50</option>\n                        <option value=\"73.00\">$73.00</option><option value=\"73.50\">$73.50</option><option value=\"74.00\">$74.00</option><option value=\"74.50\">$74.50</option><option value=\"75.00\">$75.00</option><option value=\"75.50\">$75.50</option><option value=\"76.00\">$76.00</option><option value=\"76.50\">$76.50</option>\n                        <option value=\"77.00\">$77.00</option><option value=\"77.50\">$77.50</option><option value=\"78.00\">$78.00</option><option value=\"78.50\">$78.50</option><option value=\"79.00\">$79.00</option><option value=\"79.50\">$79.50</option><option value=\"80.00\">$80.00</option><option value=\"80.50\">$80.50</option>\n                        <option value=\"81.00\">$81.00</option><option value=\"81.50\">$81.50</option><option value=\"82.00\">$82.00</option><option value=\"82.50\">$82.50</option><option value=\"83.00\">$83.00</option><option value=\"83.50\">$83.50</option><option value=\"84.00\">$84.00</option><option value=\"84.50\">$84.50</option>\n                        <option value=\"85.00\">$85.00</option><option value=\"85.50\">$85.50</option><option value=\"86.00\">$86.00</option><option value=\"86.50\">$86.50</option><option value=\"87.00\">$87.00</option><option value=\"87.50\">$87.50</option><option value=\"88.00\">$88.00</option><option value=\"88.50\">$88.50</option>\n                        <option value=\"89.00\">$89.00</option><option value=\"89.50\">$89.50</option><option value=\"90.00\">$90.00</option><option value=\"90.50\">$90.50</option><option value=\"91.00\">$91.00</option><option value=\"91.50\">$91.50</option><option value=\"92.00\">$92.00</option><option value=\"92.50\">$92.50</option>\n                        <option value=\"93.00\">$93.00</option><option value=\"93.50\">$93.50</option><option value=\"94.00\">$94.00</option><option value=\"94.50\">$94.50</option><option value=\"95.00\">$95.00</option><option value=\"95.50\">$95.50</option><option value=\"96.00\">$96.00</option><option value=\"96.50\">$96.50</option>\n                        <option value=\"97.00\">$97.00</option><option value=\"97.50\">$97.50</option><option value=\"98.00\">$98.00</option><option value=\"98.50\">$98.50</option><option value=\"99.00\">$99.00</option><option value=\"99.50\">$99.50</option><option value=\"100.00\">$100.00</option>\n                    </select>\n                </td>\n            </tr>\n            <tr>\n                <td class=\"td-left\">\n                    Price for the last \n                    <select name=\"last_seats\" [(ngModel)] = \"_bus.price.last_seats\">\n                        <option value=\"\"> </option>\n                        <option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option><option value=\"15\">15</option>\n                    </select>\n                    seats: \n                    <select name=\"last_price\" [(ngModel)] = \"_bus.price.last_price\">\n                        <option value=\"\"> </option>\n                        <option value=\"1.00\">$1.00</option><option value=\"1.50\">$1.50</option><option value=\"2.00\">$2.00</option><option value=\"2.50\">$2.50</option><option value=\"3.00\">$3.00</option><option value=\"3.50\">$3.50</option><option value=\"4.00\">$4.00</option><option value=\"4.50\">$4.50</option>\n                        <option value=\"5.00\">$5.00</option><option value=\"5.50\">$5.50</option><option value=\"6.00\">$6.00</option><option value=\"6.50\">$6.50</option><option value=\"7.00\">$7.00</option><option value=\"7.50\">$7.50</option><option value=\"8.00\">$8.00</option><option value=\"8.50\">$8.50</option>\n                        <option value=\"9.00\">$9.00</option><option value=\"9.50\">$9.50</option><option value=\"10.00\">$10.00</option><option value=\"10.50\">$10.50</option><option value=\"11.00\">$11.00</option><option value=\"11.50\">$11.50</option><option value=\"12.00\">$12.00</option><option value=\"12.50\">$12.50</option>\n                        <option value=\"13.00\">$13.00</option><option value=\"13.50\">$13.50</option><option value=\"14.00\">$14.00</option><option value=\"14.50\">$14.50</option><option value=\"15.00\">$15.00</option><option value=\"15.50\">$15.50</option><option value=\"16.00\">$16.00</option><option value=\"16.50\">$16.50</option>\n                        <option value=\"17.00\">$17.00</option><option value=\"17.50\">$17.50</option><option value=\"18.00\">$18.00</option><option value=\"18.50\">$18.50</option><option value=\"19.00\">$19.00</option><option value=\"19.50\">$19.50</option><option value=\"20.00\">$20.00</option><option value=\"20.50\">$20.50</option>\n                        <option value=\"21.00\">$21.00</option><option value=\"21.50\">$21.50</option><option value=\"22.00\">$22.00</option><option value=\"22.50\">$22.50</option><option value=\"23.00\">$23.00</option><option value=\"23.50\">$23.50</option><option value=\"24.00\">$24.00</option><option value=\"24.50\">$24.50</option>\n                        <option value=\"25.00\">$25.00</option><option value=\"25.50\">$25.50</option><option value=\"26.00\">$26.00</option><option value=\"26.50\">$26.50</option><option value=\"27.00\">$27.00</option><option value=\"27.50\">$27.50</option><option value=\"28.00\">$28.00</option><option value=\"28.50\">$28.50</option>\n                        <option value=\"29.00\">$29.00</option><option value=\"29.50\">$29.50</option><option value=\"30.00\">$30.00</option><option value=\"30.50\">$30.50</option><option value=\"31.00\">$31.00</option><option value=\"31.50\">$31.50</option><option value=\"32.00\">$32.00</option><option value=\"32.50\">$32.50</option>\n                        <option value=\"33.00\">$33.00</option><option value=\"33.50\">$33.50</option><option value=\"34.00\">$34.00</option><option value=\"34.50\">$34.50</option><option value=\"35.00\">$35.00</option><option value=\"35.50\">$35.50</option><option value=\"36.00\">$36.00</option><option value=\"36.50\">$36.50</option>\n                        <option value=\"37.00\">$37.00</option><option value=\"37.50\">$37.50</option><option value=\"38.00\">$38.00</option><option value=\"38.50\">$38.50</option><option value=\"39.00\">$39.00</option><option value=\"39.50\">$39.50</option><option value=\"40.00\">$40.00</option><option value=\"40.50\">$40.50</option>\n                        <option value=\"41.00\">$41.00</option><option value=\"41.50\">$41.50</option><option value=\"42.00\">$42.00</option><option value=\"42.50\">$42.50</option><option value=\"43.00\">$43.00</option><option value=\"43.50\">$43.50</option><option value=\"44.00\">$44.00</option><option value=\"44.50\">$44.50</option>\n                        <option value=\"45.00\">$45.00</option><option value=\"45.50\">$45.50</option><option value=\"46.00\">$46.00</option><option value=\"46.50\">$46.50</option><option value=\"47.00\">$47.00</option><option value=\"47.50\">$47.50</option><option value=\"48.00\">$48.00</option><option value=\"48.50\">$48.50</option>\n                        <option value=\"49.00\">$49.00</option><option value=\"49.50\">$49.50</option><option value=\"50.00\">$50.00</option><option value=\"50.50\">$50.50</option><option value=\"51.00\">$51.00</option><option value=\"51.50\">$51.50</option><option value=\"52.00\">$52.00</option><option value=\"52.50\">$52.50</option>\n                        <option value=\"53.00\">$53.00</option><option value=\"53.50\">$53.50</option><option value=\"54.00\">$54.00</option><option value=\"54.50\">$54.50</option><option value=\"55.00\">$55.00</option><option value=\"55.50\">$55.50</option><option value=\"56.00\">$56.00</option><option value=\"56.50\">$56.50</option>\n                        <option value=\"57.00\">$57.00</option><option value=\"57.50\">$57.50</option><option value=\"58.00\">$58.00</option><option value=\"58.50\">$58.50</option><option value=\"59.00\">$59.00</option><option value=\"59.50\">$59.50</option><option value=\"60.00\">$60.00</option><option value=\"60.50\">$60.50</option>\n                        <option value=\"61.00\">$61.00</option><option value=\"61.50\">$61.50</option><option value=\"62.00\">$62.00</option><option value=\"62.50\">$62.50</option><option value=\"63.00\">$63.00</option><option value=\"63.50\">$63.50</option><option value=\"64.00\">$64.00</option><option value=\"64.50\">$64.50</option>\n                        <option value=\"65.00\">$65.00</option><option value=\"65.50\">$65.50</option><option value=\"66.00\">$66.00</option><option value=\"66.50\">$66.50</option><option value=\"67.00\">$67.00</option><option value=\"67.50\">$67.50</option><option value=\"68.00\">$68.00</option><option value=\"68.50\">$68.50</option>\n                        <option value=\"69.00\">$69.00</option><option value=\"69.50\">$69.50</option><option value=\"70.00\">$70.00</option><option value=\"70.50\">$70.50</option><option value=\"71.00\">$71.00</option><option value=\"71.50\">$71.50</option><option value=\"72.00\">$72.00</option><option value=\"72.50\">$72.50</option>\n                        <option value=\"73.00\">$73.00</option><option value=\"73.50\">$73.50</option><option value=\"74.00\">$74.00</option><option value=\"74.50\">$74.50</option><option value=\"75.00\">$75.00</option><option value=\"75.50\">$75.50</option><option value=\"76.00\">$76.00</option><option value=\"76.50\">$76.50</option>\n                        <option value=\"77.00\">$77.00</option><option value=\"77.50\">$77.50</option><option value=\"78.00\">$78.00</option><option value=\"78.50\">$78.50</option><option value=\"79.00\">$79.00</option><option value=\"79.50\">$79.50</option><option value=\"80.00\">$80.00</option><option value=\"80.50\">$80.50</option>\n                        <option value=\"81.00\">$81.00</option><option value=\"81.50\">$81.50</option><option value=\"82.00\">$82.00</option><option value=\"82.50\">$82.50</option><option value=\"83.00\">$83.00</option><option value=\"83.50\">$83.50</option><option value=\"84.00\">$84.00</option><option value=\"84.50\">$84.50</option>\n                        <option value=\"85.00\">$85.00</option><option value=\"85.50\">$85.50</option><option value=\"86.00\">$86.00</option><option value=\"86.50\">$86.50</option><option value=\"87.00\">$87.00</option><option value=\"87.50\">$87.50</option><option value=\"88.00\">$88.00</option><option value=\"88.50\">$88.50</option>\n                        <option value=\"89.00\">$89.00</option><option value=\"89.50\">$89.50</option><option value=\"90.00\">$90.00</option><option value=\"90.50\">$90.50</option><option value=\"91.00\">$91.00</option><option value=\"91.50\">$91.50</option><option value=\"92.00\">$92.00</option><option value=\"92.50\">$92.50</option>\n                        <option value=\"93.00\">$93.00</option><option value=\"93.50\">$93.50</option><option value=\"94.00\">$94.00</option><option value=\"94.50\">$94.50</option><option value=\"95.00\">$95.00</option><option value=\"95.50\">$95.50</option><option value=\"96.00\">$96.00</option><option value=\"96.50\">$96.50</option>\n                        <option value=\"97.00\">$97.00</option><option value=\"97.50\">$97.50</option><option value=\"98.00\">$98.00</option><option value=\"98.50\">$98.50</option><option value=\"99.00\">$99.00</option><option value=\"99.50\">$99.50</option><option value=\"100.00\">$100.00</option>\n                    </select>\n                </td>\n            </tr>\n        </table>\n      </div>\n      <div class=\"group-additional-info\">\n          <table class=\"group-additional-info-table\">\n              \n              <tr>\n                  <td class=\"td-left\">\n                      Destinations: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.destination}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Bus is: \n                  </td>  \n                  <td class=\"td-right\">\n                      <select name=\"bus_mode\" [(ngModel)] = \"_bus.price.bus_opened\">\n                          <option value=\"0\">Open</option>\n                          <option value=\"1\">Closed</option>\n                      </select>\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Bus Notes:\n                  </td>\n                  <td class=\"td-left\">\n                      <input type=\"text\" name=\"note\" [(ngModel)] = \"_bus.price.bus_note\">\n                  </td>\n              </tr>\n          </table>\n          \n      </div>\n</div>\n\n\n"
...
module.exports = "<div class=\"col-xs-12 bus-root-div\">\n      <h3 class=\"text-center bus-header-h3\">BUS #{{ group_idx + 1 }}</h3>\n      \n      <div class=\"group-main-info\">\n          <table class=\"schedules-table\" *ngFor=\"let time of _bus.times; let i = index;\">\n              <tr >\n                  <td class=\"td-left\">\n                      <h5 class=\"total-h5 text-center\">TIME ID: {{ time.id }}</h5>\n                      <h5 class=\"total-h5 text-center\">{{ time.time }} from {{ time.stop_area }}</h5>\n                      <p>\n                          <select name=\"time_move\" [(ngModel)] = \"time.move\" style=\"width: 100%;\" [disabled] = \"time.reservation_cnt == 0\">\n                              <option value=\"0\">Move all these {{ time.time }} people to ...</option>\n                              <option value=\"{{_time.id}}\" *ngFor = \"let _time of _times\" [class.hidden] = \"_time.id == time.id\">  ... to the {{ _time.time }} bus from {{ _time.short }} (TIME ID: {{_time.id}})</option>\n                          </select>\n                      </p>\n                      <p>\n                          Note change in each reservation's notes \n                          <select name=\"note_change\" [(ngModel)] = \"time.note_change\">\n                            <option value=\"0\">YES</option>\n                            <option value=\"1\">NO</option>\n                          </select>\n                      </p>\n                      <p>\n                          Reason for Change: <input name=\"reason\" [(ngModel)] = \"time.reason\">\n                      </p>\n                      <p>\n                          Email the people & give them above reason: \n                          <select name=\"email_reason\" [(ngModel)] = \"time.email_reason\">\n                            <option value=\"0\">NO</option>\n                            <option value=\"1\">YES</option>\n                          </select>\n                      </p>\n                  </td>\n                  <td class=\"td-right\" style=\"width: 7%;\">\n                      <span>{{ time.reservation_cnt }}</span>\n                  </td>\n              </tr>\n          </table>\n          <p >\n              \n          </p>\n      </div>\n      <div class=\"group-additional-info\">\n          <h5 class=\"total-h5\">\n              Total: {{ total_reservation }}.  Max Capacity: {{_bus.max_cap}}\n          </h5>\n          <table class=\"group-additional-info-table\">\n              \n              <tr>\n                  <td class=\"td-left\">\n                      TravelZoo Booked: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.travel_zoo_booked}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Coupons Allowed: \n                  </td>  \n                  <td class=\"td-right\">\n                      \n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Price: \n                  </td>  \n                  <td class=\"td-right\">\n                      ${{price}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Destinations: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.destination}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Bus is: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.price.bus_opened==0?'Open':'Closed'}}\n                  </td>\n              </tr>\n          </table>\n      </div>\n</div>"
...
module.exports = "<div class=\"col-xs-12 bus-root-div\">\n      <h3 class=\"text-center bus-header-h3\">BUS #{{ group_idx + 1 }}</h3>\n      \n      <div class=\"group-main-info\">\n          <table class=\"schedules-table\">\n              <tr *ngFor=\"let time of _bus.times; let i = index;\">\n                  <td class=\"td-left\">\n                    <span>\n                        TIME ID: {{ time.id }}\n                        <input type=\"radio\" [name]=\"_busType == 0? 'outboundTime':'returnTime'\" class=\"form-control radio-btn\" (click) = \"timeSelected(time.id);\">\n                        {{ time.time }}</span> from <span>{{ time.stop_area }}\n                    </span> \n                  </td>\n                  <td class=\"td-right\">\n                      <span>{{ time.reservation_cnt }}</span>\n                  </td>\n              </tr>\n          </table>\n          <p >\n              \n          </p>\n      </div>\n      <div class=\"group-additional-info\">\n          <h5 class=\"total-h5\">\n              Total: {{ total_reservation }}.  Max Capacity: {{_bus.max_cap}}\n          </h5>\n          <table class=\"group-additional-info-table\">\n              \n              <tr>\n                  <td class=\"td-left\">\n                      TravelZoo Booked: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.travel_zoo_booked}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Coupons Allowed: \n                  </td>  \n                  <td class=\"td-right\">\n                      \n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Price: \n                  </td>  \n                  <td class=\"td-right\">\n                      ${{price}}\n                  </td>\n              </tr>\n          </table>\n          \n      </div>\n      <div class=\"group-additional-info\">\n          <table class=\"group-additional-info-table\">\n              \n              <tr>\n                  <td class=\"td-left\">\n                      Destinations: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.destination}}\n                  </td>\n              </tr>\n              <tr>\n                  <td class=\"td-left\">\n                      Bus is: \n                  </td>  \n                  <td class=\"td-right\">\n                      {{_bus.price.bus_opened==0?'Open':'Closed'}}\n                  </td>\n              </tr>\n          </table>\n          \n      </div>\n</div>\n\n\n"
...
module.exports = "<div class=\"text-center header-div\">\n    <label >\n        <img class=\"img-responsive\" src=\"./assets/common/img/reg_mode_b.gif\" width=\"192\" height=\"59\" alt=\"Regular Mode\">\n    </label>\n    \n    <label style=\"vertical-align: top;\" (click)=\"onClickBusEditMode()\">\n        <img class=\"img-responsive\" src=\"./assets/common/img/bus_edit_mode_r.gif\" width=\"192\" height=\"45\" alt=\"Bus Prices Mode\">\n    </label>\n    \n    <label style=\"vertical-align: top;\" (click)=\"onClickMovePeopleMode()\">\n        <img class=\"img-responsive\" src=\"./assets/common/img/move_people_mode_r.gif\" width=\"192\" height=\"45\" alt=\"Move People Mode\">\n    </label>\n</div>\n\n<!--<div class=\"row row-content\" >\n    <div class=\"col-sm-6\" style=\"text-align: center;\">\n        <h3>Leaving from {{ headerLeave.city }} on </h3>\n        <p>{{ headerLeave.date}} at:</p>\n    </div>\n    <div class=\"col-sm-6\" style=\"text-align: center;\">\n        <h3>Returning from {{ headerReturn.city }} on </h3>\n        <p>{{ headerReturn.date }} at: </p>\n    </div>\n</div>-->\n<div class=\"row row-content\" >\n    <div class=\"col-sm-6\" style=\"text-align: center;\" [class.wide] = \"headerReturn.date == ''\">\n        <div class=\"header-outbound\">\n                <h3>Leaving from {{ headerLeave.city }} on </h3>\n                <p>{{ headerLeave.date}} at:</p>\n        </div>\n        <div class=\"content-outbound\">\n                <div *ngFor=\"let bus of leaving_buses; let i = index;\"> \n                    <app-admin-main-bus [bus] = \"bus\" [selected_group_idx] = \"i\" (onTimeSelected) = \"outboundTimeSelected($event);\"></app-admin-main-bus>\n                </div>\n        </div>\n    </div>\n    <div class=\"col-sm-6\" style=\"text-align: center;\" *ngIf = \"headerReturn.date != ''\">\n        <div class=\"header-return\">\n                <h3>Returning from {{ headerReturn.city }} on </h3>\n                <p>{{ headerReturn.date }} at: </p>\n        </div>\n        <div class=\"content-outbound\">\n                <div *ngFor=\"let bus of returning_buses; let i = index;\"> \n                    <app-admin-main-bus [bus] = \"bus\" [selected_group_idx] = \"i\" (onTimeSelected) = \"returningTimeSelected($event);\" [busType] = \"1\"></app-admin-main-bus>\n                </div>\n        </div>\n    </div>\n</div>\n<div class=\"row text-center\" style=\"margin-bottom: 50px;\" *ngIf = \"outbound_timeId != 0\">\n    <div class=\"alert alert-success \" style=\"margin: 20px 0px;\">\n        <button aria-label=\"Close\" class=\"close\" type=\"button\" (click) = \"successMessage = ''\">\n            <!--<span aria-hidden=\"true\">×</span>-->\n        </button>\n        <p>\n            Outbound Choice: ${{outbound_price}} . <span *ngIf = \"returning_timeId != 0\">Return Choice: ${{returning_price}}.</span>\n        </p>\n        <p>Total Per Seat: ${{outbound_price + returning_price}}</p>\n    </div>\n    <button type=\"button\" class=\"btn btn-primary\" (click) = \"gotoNextStep();\">Next Step</button>\n</div>\n"
...
var _a;
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/auth.service.js.map
...
//# sourceMappingURL=E:/Php_projects/TripperBus/BackEnd/FrontEnd/src/bus.type.js.map
