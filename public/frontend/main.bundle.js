...
var AdminSchedulesEditexistingComponent = (function () {
    ...
    AdminSchedulesEditexistingComponent.prototype.receiveParamsFromRoute = function () {
        ...
        this.inputParams.type = this._route.snapshot.params['sel_type'];
...
var AdminSchedulesComponent = (function () {
    ...
    AdminSchedulesComponent.prototype.onEditSchedule = function (area_id) {
        this.hideModal();
        var link = ['/admin/schedules_edit', this.selected_date, this._commonService.scheduleType.TYPE_EDIT_EXISTING, area_id];
        this._router.navigate(link);
    };
    AdminSchedulesComponent.prototype.onGenNewSchedule = function (area_id) {
        this.hideModal();
        var link = ['/admin/schedules_edit', this.selected_date, this._commonService.scheduleType.TYPE_GENERATE_NEW, area_id];
        this._router.navigate(link);
    };
    AdminSchedulesComponent.prototype.onGenSpecialSchedule = function (area_id) {
        this.hideModal();
...
/* unused harmony export TYPE_EDIT_EXISTING */
/* unused harmony export TYPE_GENERATE_NEW */
/* unused harmony export TYPE_GENERATE_SPECIAL */
...
var TYPE_EDIT_EXISTING = 0;
var TYPE_GENERATE_NEW = 1;
var TYPE_GENERATE_SPECIAL = 2;
